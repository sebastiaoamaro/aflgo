...
sudo grep -q '#include <cstdlib>' /home/vagrant/aflgo/instrument/llvm_tools/compiler-rt/lib/dfsan/dfsan.cpp || (sudo cp /home/vagrant/aflgo/instrument/llvm_tools/compiler-rt/lib/dfsan/dfsan.cpp{,.bak} && sudo sed -i '0,/#include <stdlib.h>/s//#include <stdlib.h>\n#include <cstdlib>/' /home/vagrant/aflgo/instrument/llvm_tools/compiler-rt/lib/dfsan/dfsan.cpp)
